...
Each variable does not have its own column, they are also grouped in a single row of religion.

3. Use `pivot_longer()` to make the data tidy.  
```{r}
relig_income %>% 
  pivot_longer(-religion,
               names_to = "amount earned", 
               values_to = "how many people"
               )
```
