...
```
## here() starts at C:/Users/Tati/Desktop/BIS15W2023_taguilar
```
...
```
The data is "tidy" per the definitions of the tidyverse as each variable has it's own column, each observation has its own row, and each value has its own cell. They seem to be in long format.
